...
export const userProfessionalScheduleConfigs = professionalSchema.table(
...
export const userProfessionalScheduleConfigSlots = professionalSchema.table(
...
export const userProfessionalScheduleConfigBlocks = professionalSchema.table(
