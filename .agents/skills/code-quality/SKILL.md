...
6. **Fixed language** — see [`AGENTS.md`](../../../AGENTS.md) (Two standing rules).
...
- Identifiers vs. comments/docstrings/user-facing errors: see [`AGENTS.md`](../../../AGENTS.md) (Two standing rules).
...
□ Language: see AGENTS.md (Two standing rules)
