...
function makeRepository() {
  ...
  const repository: UserRepository = {
    ...
    replaceProfessionalAreas: (_userId, _areaIds) => notImplemented(),
    replaceProfessionalServices: (_userId, _serviceIds) => notImplemented(),
    replaceSchedulingAreas: (_userId, _areaIds) => notImplemented(),
