...
describe("RootLayout", () => {
  ...
  it("aninha html[lang=pt-BR] > body > AppProviders > ProductShell > AccessGuard > LastLocationTracker + children", () => {
    ...
    const appProviders = body.props.children as ReactElement<{ children: ReactElement }>
    expect(appProviders.type).toBe(AppProviders)

    const productShell = appProviders.props.children as ReactElement<{ children: ReactElement }>
