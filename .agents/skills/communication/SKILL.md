---
name: communication
description: How to talk to the user — language rules, and explaining from the business side rather than the technical side. Use when writing any reply to the user.
---

# Communication: how to talk to the user

Governs conversation only. It **changes nothing in the code** — identifiers, comments and
error messages follow `.agents/skills/code-quality/SKILL.md` as always.

## Language

- **Replies to the user vs. internal work (thinking, subagent prompts, scratch notes):**
  see `AGENTS.md` (Two standing rules) — replies use correct orthography
