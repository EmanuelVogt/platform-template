...
/**
 * Preenchimento do slot quando o produto não está montado (filho sem os módulos
 * de agenda): sem catálogo para consultar, toda área/serviço passa — a
 * obrigatoriedade de ≥1 área continua sendo do use case.
 */
@Injectable()
