...
**Language**: the conversation follows the user; `spec.md`, `context.md` and the feature slug are English (SKILL.md Critical Rule 6). Translate what the user said into English requirements as you record them — quote pt-BR only for a UI label, an error message or a domain term with no English equivalent.
