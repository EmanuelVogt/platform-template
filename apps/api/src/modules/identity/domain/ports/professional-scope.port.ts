/**
 * Valida as áreas/serviços de atuação de um Profissional. Port invertido: o
 * identity não conhece quem sabe responder — o adapter entra pelo slot de
 * `IdentityModule.forRoot` (null object quando o produto não está montado).
 * Ver ADR 0032.
 */
