...
| ACC-12 DOC-01..07 present | each listed doc change exists | DOC-01 `docs/front/front-arch.md:343,352,356,434,441,459-461,474,482-487`; DOC-02 `docs/dev/template.md:24-26`; DOC-03 `README.md.jinja:18`, `AGENTS.md.jinja:38`; DOC-04 `docs/dev/deploy.md.jinja:35,48`; DOC-05 `docs/dev/template-changelog.md:7,9`; DOC-06 `.specs/STATE.md:35` (AD-027); DOC-07 `catalog/identity/single-tenant/README.md:346,355,369` | ✅ (⚠️ DOC-03, below) |
