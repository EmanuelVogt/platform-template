...
export interface UserRepository {
  ...
  replacePermissions(userId: string, permissions: readonly PermissionKey[]): Promise<void>;
  /** Substitui as áreas de atuação do Profissional (delete + insert na mesma tx). */
  replaceProfessionalAreas(userId: string, areaIds: readonly string[]): Promise<void>;
  /** Substitui os serviços de atuação do Profissional (delete + insert na mesma tx). */
  replaceProfessionalServices(userId: string, serviceIds: readonly string[]): Promise<void>;
  /** Substitui as áreas de agendamento do perfil Agendamentos (delete + insert na mesma tx). */
  replaceSchedulingAreas(userId: string, areaIds: readonly string[]): Promise<void>;
